...
import com.galaxy.common.string.GalaxyStringUtils;
...
import static com.galaxy.base.ConstantConfItem.JOB_NAME_ITEM;
import static com.galaxy.base.ConstantPath.STATUS_PATH;
...
public class TimestampImportInputFile implements InputFile {
    ...
    public void end(FileSystem fs, Configuration conf) throws IOException {
        Path basePath = new Path(STATUS_PATH, conf.get(JOB_NAME_ITEM));
